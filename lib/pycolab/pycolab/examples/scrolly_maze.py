...
def make_game(level):
  ...
  print('patroller_a_position', patroller_a_position)
  print('patroller_b_position', patroller_b_position)
  print('patroller_c_position', patroller_c_position)
  #print('coins_kwargs', coins_kwargs)
  #exit()
